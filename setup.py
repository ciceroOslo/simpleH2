...
PACKAGE_NAME = "simpleh2"
AUTHORS = [
    ("Marit Sandstad", "marit.sandstad@cicero.oslo.no"),
    ("Ragnhild Bieltvedt Skeie", "r.b.skeie@cicero.oslo.no"),
]
URL = "https://github.com/ciceroOslo/simpleh2"

DESCRIPTION = "Simple H2 model that goes from emissions to concentrations"
README = "README.rst"
...
PACKAGE_DATA = {"simpleh2": [os.path.join("default_data", "*.txt")]}

# Get the long description from the README file
with open(README, "r") as f:
    README_LINES = ["simpleh2", "==============", ""]
    add_line = False
    for line in f:
...
setup(
    ...
    keywords=["molevular hydrogen", "cicero", "python", "simple", "model"],
    packages=PACKAGES,
